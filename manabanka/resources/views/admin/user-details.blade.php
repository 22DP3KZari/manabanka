        ...
        <div class="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-xl overflow-hidden">
            ...
            <div class="hidden md:block">
                <table class="min-w-full divide-y divide-slate-700/50">
                    <thead>
                        <tr>
                            <th class="py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-400 uppercase sm:pl-6">{{ __('common.category') }}</th>
                    ...
                    <tbody class="divide-y divide-slate-700/50">
                        @forelse($user->spendings as $transaction)
                        <tr class="hover:bg-slate-800/40 transition-colors">
                            <td class="whitespace-nowrap py-4 pl-4 text-sm font-medium text-white sm:pl-6">{{ __('common.category_' . $transaction->category) }}</td>
                ...
                <div class="px-4 py-3">
                    <div class="flex justify-between items-start gap-3">
                        <div class="min-w-0 flex-1">
                            <p class="text-sm font-medium text-white">{{ __('common.category_' . $transaction->category) }}</p>
