...
@section('content')
    ...
    <form action="{{ route('admin.lessons.update', $lesson) }}" method="POST" autocomplete="off" class="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-xl overflow-hidden [contain:layout]">
        @csrf
        @method('PUT')

        <div class="p-4 sm:p-6 space-y-6">
            <!-- English reference -->
            <div class="p-4 rounded-xl bg-slate-900/60 border border-slate-700/50" translate="no" data-grammarly="false" data-ms-editor="false">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="title_lv" name="title_lv" value="{{ old('title_lv', $lesson->title_lv) }}" required spellcheck="true" data-grammarly="false" data-ms-editor="false"
                ...
                <div>
                    ...
                    <textarea id="description_lv" name="description_lv" rows="3" spellcheck="false" autocorrect="off" autocapitalize="off" data-grammarly="false" data-ms-editor="false"
                ...
                <div>
                    ...
                    <textarea id="content_lv" name="content_lv" rows="18" spellcheck="false" autocorrect="off" autocapitalize="off" data-grammarly="false" data-ms-editor="false"
