            ...
            <table class="min-w-full divide-y divide-slate-700/50">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">{{ __('common.admin_recipient') }}</th>
                ...
                <tbody class="divide-y divide-slate-700/50">
                    ...
                    <tr class="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-400">{{ $transaction->recipient_name }}</td>
            ...
            <div class="p-4 active:bg-slate-800/40 transition-colors">
                <div class="flex justify-between items-start gap-3">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-xs text-gray-400 truncate mt-0.5">{{ $transaction->recipient_name }}</p>
