...
<div class="max-w-2xl mx-auto py-10">
    ...
    <form action="{{ route('budget-planner.calculate') }}" method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow" id="budgetForm">
        @csrf
        <div>
            <label for="age" class="block text-sm font-medium text-gray-700">Age</label>
            <input type="number" name="age" id="age" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your age">
        </div>
        <div>
            <label for="income" class="block text-sm font-medium text-gray-700">Monthly Income (€)</label>
            <input type="number" step="0.01" name="income" id="income" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly income">
        </div>
        ...
        <div class="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" step="0.01" name="housing" id="housing" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly housing costs">
                </div>
                <div>
                    <label for="utilities" class="block text-sm font-medium text-gray-700">Utilities (Electricity, Water, Internet) (€)</label>
                    <input type="number" step="0.01" name="utilities" id="utilities" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly utilities costs">
                </div>
                <div>
                    <label for="transportation" class="block text-sm font-medium text-gray-700">Transportation (Fuel, Public Transport) (€)</label>
                    <input type="number" step="0.01" name="transportation" id="transportation" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly transportation costs">
                </div>
                <div>
                    <label for="groceries" class="block text-sm font-medium text-gray-700">Groceries (€)</label>
                    <input type="number" step="0.01" name="groceries" id="groceries" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly grocery expenses">
                </div>
                <div>
                    <label for="insurance" class="block text-sm font-medium text-gray-700">Insurance (Health, Car, etc.) (€)</label>
                    <input type="number" step="0.01" name="insurance" id="insurance" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly insurance costs">
                </div>
                <div>
                    <label for="loan_payments" class="block text-sm font-medium text-gray-700">Loan Payments (excluding mortgage) (€)</label>
                    <input type="number" step="0.01" name="loan_payments" id="loan_payments" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly loan payments">
                </div>
                <div>
                    <label for="personal_care" class="block text-sm font-medium text-gray-700">Personal Care (Haircuts, etc.) (€)</label>
                    <input type="number" step="0.01" name="personal_care" id="personal_care" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required min="0" placeholder="Enter your monthly personal care expenses">
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 p-4 bg-purple-50 rounded-lg">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" step="0.01" name="dining_out" id="dining_out" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500" required min="0" placeholder="Enter your monthly dining out expenses">
                </div>
                <div>
                    <label for="shopping" class="block text-sm font-medium text-gray-700">Shopping (€)</label>
                    <input type="number" step="0.01" name="shopping" id="shopping" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500" required min="0" placeholder="Enter your monthly shopping expenses">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="subscriptions" id="subscriptions" class="expense-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500" required min="0" placeholder="Enter your monthly subscription costs">
                </div>
                <div>
        ...
        <div class="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="dependents" id="dependents" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500" required min="0" placeholder="Enter number of dependents">
                </div>
                <div>
        ...
        <button type="submit" id="submitButton" class="w-full bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700">Calculate Budget</button>
    </form>
</div>
